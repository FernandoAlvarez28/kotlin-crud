...
class PurchaseApiController(val logger: Logger = Logger.getLogger(PurchaseApiController::class.qualifiedName), val purchaseService: PurchaseService) {
    ...
    @GetMapping("/api/v1/purchases", produces = [MediaType.APPLICATION_JSON_VALUE])
    ...
    @GetMapping("/api/v1/purchases/{id}", produces = [MediaType.APPLICATION_JSON_VALUE])
    ...
    @PostMapping("/api/v1/purchases", consumes = [MediaType.APPLICATION_JSON_VALUE], produces = [MediaType.APPLICATION_JSON_VALUE])
